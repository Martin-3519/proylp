...
CREATE TABLE personas( idUser int not null auto_increment PRIMARY KEY,
usuario varchar(50) NOT NULL , clave varchar(15) NOT NULL, fecha DATETIME ,
descripcion varchar(200));

INSERT INTO personas(usuario, clave, fecha, descripcion) 
...
INSERT INTO personas(usuario, clave, fecha, descripcion) 
VALUES('martin','gimenez','2022-11-23','usuario5');
INSERT INTO personas(usuario, clave, fecha, descripcion) 
VALUES('sebastian','fernandez','2022-12-09','usuario6');
...
CREATE TABLE IF NOT EXISTS autos (
    idCar INT not null  PRIMARY KEY AUTO_INCREMENT,
...
INSERT INTO autos(nombre_auto, marca_auto, descripcion_auto, fecha_ingreso,stock) 
VALUES('Supra','Toyota','nuevito de fabrica','2022-12-05',5),
('Skyline','Nissan','Llega a lo 200km/h','2023-01-01',2),
('Eclipse','Mitsubishi','normalito','2023-03-05',10),
('QQ','Chery','Muy visto y barato','2022-12-12',50);